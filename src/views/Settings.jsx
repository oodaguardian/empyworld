...
function saveSettings(s) { if (typeof window !== 'undefined') localStorage.setItem(SETTINGS_KEY, JSON.stringify(s)); }
function getPin() { return typeof window !== 'undefined' ? localStorage.getItem(PIN_KEY) : null; }
function setPin(p) { if (typeof window !== 'undefined') localStorage.setItem(PIN_KEY, p); }
